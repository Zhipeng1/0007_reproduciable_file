...
#### 2.2 [This is the local authority level geographic data needed in this study](https://geoportal.statistics.gov.uk/datasets/ons::local-authority-districts-may-2021-uk-bfe/about) , <ins>you need to download it manually and copy it into the same path locally</ins>![image](https://user-images.githubusercontent.com/91874485/149977634-1aa805c8-cd14-49ca-93ce-5c11d4d72b99.png)

#### 2.3 You will use jupyter-notebook to open the CASA_0007_assessment_3_code.ipynb file to run the code.


### 3 Data:  
#### 2.1 ULEV related data and social economic data were already downloaded from government website and they are all in the different sheets of "data.xlsx".
